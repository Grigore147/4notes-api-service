...
final class AuthenticationException extends LaravelAuthenticationException
{
    public function __construct($message = '', $guards = [], $exception = null)
    {
        parent::__construct($message, $exception->guards());
    }
    ...
    public function render(Request $request): Response|JsonResponse|bool
    {
        ...
        ], HttpResponse::HTTP_UNAUTHORIZED, $headers);
    }
}
